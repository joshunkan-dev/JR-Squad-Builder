const players = [
  {
    ...
    birthCity: "Hershey",
    birthCountry: "USA",
    seasonStats: { appearances: 36, goals: 15, assists: 9 },
    eligibleCountries: ["USA", "Croatia"],
  ...
  },
  {
    ...
    birthCity: "New York",
    birthCountry: "USA",
    seasonStats: { appearances: 28, goals: 10, assists: 3 },
    eligibleCountries: ["USA", "England", "Nigeria"],
    showDualFlagsOnCard: false,
  },
  {
    id: "weah",
    displayName: "Weah",
    position: "RW",
    transfermarktId: "406635",
    age: 26,
    club: "Juventus",
    clubCountry: "Italy",
    birthCity: "New York",
    birthCountry: "USA",
    seasonStats: { appearances: 34, goals: 6, assists: 8 },
    eligibleCountries: ["USA", "Liberia", "Jamaica", "France"],
    showDualFlagsOnCard: false,
  },
  {
    id: "mckennie",
    ...
    club: "Juventus",
    clubCountry: "Italy",
    birthCity: "Little Elm",
    birthCountry: "USA",
    seasonStats: { appearances: 35, goals: 4, assists: 9 },
  ...
  },
  {
    ...
    displayName: "Musah",
    position: "CM",
    transfermarktId: "503991",
    age: 23,
    club: "AC Milan",
    clubCountry: "Italy",
    birthCity: "New York",
    birthCountry: "USA",
    seasonStats: { appearances: 31, goals: 2, assists: 3 },
    eligibleCountries: ["USA", "England", "Ghana", "Italy"],
    showDualFlagsOnCard: false,
  },
  {
    id: "adams",
    ...
    clubCountry: "England",
    birthCity: "Wappingers Falls",
    birthCountry: "USA",
    seasonStats: { appearances: 24, goals: 1, assists: 2 },
    eligibleCountries: ["USA"],
    showDualFlagsOnCard: false,
  },
  {
    ...
    club: "Fulham",
    clubCountry: "England",
    birthCity: "Milton Keynes",
    birthCountry: "England",
    seasonStats: { appearances: 35, goals: 1, assists: 8 },
    eligibleCountries: ["USA", "England"],
    showDualFlagsOnCard: false,
  },
  {
    id: "ream",
    displayName: "Ream",
    position: "CB",
    transfermarktId: "33395",
    age: 38,
    club: "Charlotte FC",
    clubCountry: "USA",
    birthCity: "St. Louis",
    birthCountry: "USA",
    seasonStats: { appearances: 25, goals: 1, assists: 1 },
    eligibleCountries: ["USA"],
    showDualFlagsOnCard: false,
  },
  {
    ...
    position: "CB",
    transfermarktId: "434435",
    age: 26,
    club: "Crystal Palace",
    clubCountry: "England",
    birthCity: "Birmingham, Alabama",
    birthCountry: "USA",
    seasonStats: { appearances: 27, goals: 1, assists: 1 },
    eligibleCountries: ["USA"],
    showDualFlagsOnCard: false,
  },
  {
    ...
    seasonStats: { appearances: 30, goals: 2, assists: 6 },
    eligibleCountries: ["USA", "Netherlands", "Suriname"],
    showDualFlagsOnCard: false,
  },
  {
    id: "turner",
    displayName: "Turner",
    position: "GK",
    transfermarktId: "312151",
    age: 32,
    club: "Nottingham Forest",
    clubCountry: "England",
    birthCity: "Park Ridge",
    birthCountry: "USA",
    seasonStats: { appearances: 20, goals: 0, assists: 0 },
    eligibleCountries: ["USA", "Lithuania"],
    showDualFlagsOnCard: false,
  },
  {
    id: "pepi",
    displayName: "Pepi",
    position: "ST",
    transfermarktId: "628264",
    age: 23,
    club: "PSV",
    clubCountry: "Netherlands",
    birthCity: "El Paso",
    birthCountry: "USA",
    seasonStats: { appearances: 32, goals: 14, assists: 4 },
    eligibleCountries: ["USA", "Mexico"],
    showDualFlagsOnCard: false,
  },
  {
    id: "reyna",
    ...
    birthCountry: "England",
    seasonStats: { appearances: 21, goals: 3, assists: 4 },
    eligibleCountries: ["USA", "England", "Argentina", "Portugal"],
    showDualFlagsOnCard: false,
  },
  {
    id: "scally",
    ...
    clubCountry: "Germany",
    birthCity: "Lake Grove",
    birthCountry: "USA",
    seasonStats: { appearances: 33, goals: 2, assists: 3 },
    eligibleCountries: ["USA"],
    showDualFlagsOnCard: false,
  },
  {
    id: "koleosho",
    displayName: "Koleosho",
    position: "LW",
    transfermarktId: "1058291",
    age: 20,
    club: "Burnley",
    clubCountry: "England",
    birthCity: "Norwalk",
    birthCountry: "USA",
    seasonStats: { appearances: 24, goals: 2, assists: 4 },
    eligibleCountries: ["USA", "Italy", "Nigeria"],
    showDualFlagsOnCard: true,
  },
  {
    id: "culbreath",
    displayName: "Culbreath",
    position: "ST",
    transfermarktId: "1173321",
    age: 19,
    club: "SC Freiburg II",
    clubCountry: "Germany",
    birthCity: "Munich",
    birthCountry: "Germany",
    seasonStats: { appearances: 18, goals: 5, assists: 2 },
    eligibleCountries: ["USA", "Germany"],
    showDualFlagsOnCard: true,
  },
  {
    id: "west",
    displayName: "West",
    position: "CM",
    transfermarktId: "1216497",
    age: 18,
    club: "Vålerenga",
    clubCountry: "Norway",
    birthCity: "Oslo",
    birthCountry: "Norway",
    seasonStats: { appearances: 16, goals: 1, assists: 3 },
    eligibleCountries: ["USA", "Norway"],
    showDualFlagsOnCard: true,
  },
  {
    id: "emenalo",
    displayName: "Emenalo",
    position: "CAM",
    transfermarktId: "1018780",
    age: 17,
    club: "Chelsea U21",
    clubCountry: "England",
    birthCity: "London",
    birthCountry: "England",
    seasonStats: { appearances: 17, goals: 6, assists: 4 },
    eligibleCountries: ["USA", "England", "Nigeria"],
    showDualFlagsOnCard: true,
  },
  {
    ...
    displayName: "Chase",
    position: "CB",
    transfermarktId: "1026422",
    age: 20,
    club: "VfB Stuttgart II",
    clubCountry: "Germany",
    birthCity: "Yokosuka",
    birthCountry: "Japan",
    seasonStats: { appearances: 20, goals: 1, assists: 1 },
    eligibleCountries: ["USA", "Japan"],
    showDualFlagsOnCard: true,
  },
  ...
  { id: "pukstas", displayName: "Pukstas", position: "CM", transfermarktId: "918784", age: 21, club: "Hajduk Split", clubCountry: "Croatia", birthCity: "Stillwater", birthCountry: "USA", seasonStats: { appearances: 30, goals: 4, assists: 3 }, eligibleCountries: ["USA", "Lithuania"], showDualFlagsOnCard: true },
  ...
  { id: "luna", displayName: "Luna", position: "CAM", transfermarktId: "805385", age: 21, club: "Real Salt Lake", clubCountry: "USA", birthCity: "Sunnyvale", birthCountry: "USA", seasonStats: { appearances: 31, goals: 8, assists: 9 }, eligibleCountries: ["USA", "Mexico"], showDualFlagsOnCard: true },
...
const formations = {
  433: [
    ...
    { key: "lb", label: "LB", x: 14, y: 70 },
    { key: "lcb", label: "CB", x: 38, y: 72 },
    { key: "rcb", label: "CB", x: 62, y: 72 },
    { key: "rb", label: "RB", x: 86, y: 70 },
    { key: "lcm", label: "CM", x: 28, y: 50 },
    { key: "cm", label: "CDM", x: 50, y: 56 },
    { key: "rcm", label: "CM", x: 72, y: 50 },
    { key: "lw", label: "LW", x: 20, y: 24 },
    { key: "st", label: "ST", x: 50, y: 20 },
    { key: "rw", label: "RW", x: 80, y: 24 },
  ],
  442: [
    { key: "gk", label: "GK", x: 50, y: 90 },
    { key: "lb", label: "LB", x: 14, y: 70 },
    ...
    { key: "lcm", label: "CM", x: 38, y: 48 },
    { key: "rcm", label: "CM", x: 62, y: 48 },
  ...
  3421: [
    { key: "gk", label: "GK", x: 50, y: 90 },
    { key: "lcb", label: "CB", x: 28, y: 72 },
    { key: "cb", label: "CB", x: 50, y: 74 },
    { key: "rcb", label: "CB", x: 72, y: 72 },
    { key: "lwb", label: "LWB", x: 12, y: 52 },
    { key: "lcm", label: "CM", x: 40, y: 56 },
    { key: "rcm", label: "CM", x: 60, y: 56 },
    { key: "rwb", label: "RWB", x: 88, y: 52 },
    { key: "lam", label: "AM", x: 40, y: 32 },
    { key: "ram", label: "AM", x: 60, y: 32 },
    { key: "st", label: "ST", x: 50, y: 18 },
  ],
};

const flagClassMap = {
  USA: "usa", Italy: "italy", Nigeria: "nigeria", Germany: "germany", Norway: "norway", England: "england", Japan: "japan", Croatia: "croatia", Liberia: "liberia", Jamaica: "jamaica", France: "france", Ghana: "ghana", Netherlands: "netherlands", Suriname: "suriname", Lithuania: "lithuania", Mexico: "mexico", Argentina: "argentina", Portugal: "portugal", Denmark: "denmark",
};
...
const getPrimaryPhoto = (player) => {
  if (player.explicitPhoto) return player.explicitPhoto;
  return `https://img.a.transfermarkt.technology/portrait/header/${player.transfermarktId}.jpg`;
};

const getPhotoFallback = (player) =>
  ["pulisic", "balogun"].includes(player.id) ? player.explicitPhoto || getPrimaryPhoto(player) : "./playerface.jpg";

const createFlag = (country) => {
  const flag = document.createElement("span");
  flag.className = `country-flag ${flagClassMap[country] || "usa"}`;
...
const buildFlagRow = (container, player) => {
  container.innerHTML = "";
  const flagsToShow = player.showDualFlagsOnCard ? player.eligibleCountries : ["USA"];
  flagsToShow.forEach((country) => container.append(createFlag(country)));
};

const openPlayerModal = (player) => {
  const photoUrl = getPrimaryPhoto(player);
  modalTitle.textContent = `${player.displayName} (${player.position})`;
  modalBody.innerHTML = `
    <div class="modal-player">
      <img src="${photoUrl}" alt="${player.displayName}" class="modal-player-face" id="modal-face" />
      <ul>
  ...
  modalFace.onerror = () => { modalFace.src = getPhotoFallback(player); };

  const clubFlagWrap = document.getElementById("club-flag-wrap");
  const birthFlagWrap = document.getElementById("birth-flag-wrap");
  clubFlagWrap.append(createFlag(player.clubCountry));
  birthFlagWrap.append(createFlag(player.birthCountry));
...
const createPlayerCard = (player, inLineup = false) => {
  ...
  face.onerror = () => { face.src = getPhotoFallback(player); };
...
const renderPlayerList = () => {
  ...
  players
    ...
    .forEach((player) => playerListEl.append(createPlayerCard(player, false)));
};
